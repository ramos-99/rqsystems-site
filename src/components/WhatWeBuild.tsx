    ...
    <div className="relative w-full max-w-[480px] mx-auto aspect-[4/3]" aria-hidden="true">
      {marks.map((m, i) => (
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="absolute h-auto text-white -translate-x-1/2 -translate-y-1/2"
...
export default function WhatWeBuild() {
  return (
    <section
      id="what-we-build"
      className="border-t border-[#1e1e1e] relative overflow-hidden"
      style={{ background: '#0a0a0a' }}
    >
      {/* single soft ambient lift, lighter than the hero */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(60% 50% at 78% 28%, rgba(255,255,255,0.035) 0%, transparent 60%)' }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-16 py-20 md:py-32 grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
        ...
        <div className="max-w-xl">
          <h2 className="text-4xl md:text-5xl lg:text-6xl text-white leading-none" style={GLOOCK}>
            What we build
          </h2>

          <div className="mt-8 md:mt-10 space-y-6 text-[#828282] text-base md:text-[17px] leading-relaxed font-sans">
            <p>
